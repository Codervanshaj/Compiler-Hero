...
<body>
	...
	<header>
		<div class="nav" id="nav">
			...
			<ul id="list-switch">
				<li><a href="#"><img src="../coursesimg/courses/d1.png" class="icon">JEE</a></li>
	...
	<div class="title">
		<span>Prepare for JEE Mains & Advanced<br>on Compiler Hero</span>
		<div class="shortdesc">
...
<!-- COURSES AVAILABLE -->
	...
	<center>
		<div class="ccardbox">
			<div class="dcard">
				<div class="fpart"><img src="../coursesimg/courses/organic.jpg"></div>
				<a href="#organic"><div class="spart">2 Courses <img src="../coursesimg/icon/dropdown.png"></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src="../coursesimg/courses/inorganic.jpg"></div>
				<a href="#inorganic"><div class="spart">5 Courses <img src="../coursesimg/icon/dropdown.png"></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src="../coursesimg/courses/physical.jpg"></div>
				<a href="#physical"><div class="spart">3 Courses <img src="../coursesimg/icon/dropdown.png"></div></a>
			</div>
		</div>
		<div class="ccardbox">
			<div class="dcard">
				<div class="fpart"><img src="../coursesimg/courses/physics.jpg"></div>
				<a href="#physics"><div class="spart">6 Courses <img src="../coursesimg/icon/dropdown.png"></div></a>
			</div>
			<div class="dcard">
			...
			<div class="dcard">
				<div class="fpart"><img src="../coursesimg/courses/paper-download.png"></div>
				<a href="#sample_papers"><div class="spart">1 Courses <img src="../coursesimg/icon/dropdown.png"></div></a>
			</div>
		</div>
	</center>
	</div>
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="../coursesimg/courses/organic.jpg">
...
<!-- VIDEOS SECTION -->
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="../coursesimg/courses/inorganic.jpg">
...
<!-- VIDEOS SECTION -->
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="../coursesimg/courses/physical.jpg">
...
<!-- VIDEOS SECTION -->
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="../coursesimg/courses/physics.jpg">
...
<footer>
	<div class="footer-container">
		<div class="left-col">
			...
			<div class="logo"><h1  style="width: 200px;">Compiler Hero</h1></div>
			...
			<p><img src="../coursesimg/icon/phone.png"> +91 7878620980<br><img src="../coursesimg/icon/mail.png">&nbsp; vanshajagarwal@gmail.com</p>
		</div>
		<div class="right-col">
