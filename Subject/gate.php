...
<head>
	...
	<title>Prepare for GATE on Compiler Hero</title>
...
<!-- NAVIGATION -->
	<header>
		<div class="nav" id="nav">
			<div id="learned-logo">
			<a href="../course.php"><img src="../coursesimg/icon/logo.png" style="width: 120px;"></a></div>
			<div class="switch-tab" id="switch-tab" onclick="switchTAB()"><img src="../coursesimg/icon/menu.png"></div>
			<ul id="list-switch">
				<li><a href="jee.php"><img src="../coursesimg/courses/d1.png" class="icon">JEE</a></li>
				<li><a href="#"><img src="../coursesimg/courses/paper.png" class="icon">GATE</a></li>
				<li><a href="computer_courses.php"><img src="../coursesimg/courses/computer.png" class="icon">Computer Courses</a></li>
				<li><a href="computer_courses.php#data"><img src="../coursesimg/courses/data.png" class="icon">Data Structures</a></li>
				<li><a href="computer_courses.php#algo"><img src="../coursesimg/courses/algo.png" class="icon">Algorithm</a></li>
				<li><a href="computer_courses.php#projects"><img src="../coursesimg/courses/projects.png" class="icon">Projects</a></li>
			</ul>
			<div class="search" id="search-switch">
				<input type="text" placeholder="Search" class="srch"><button id="srchbtn"><img src="../coursesimg/icon/search.png"></button>
			</div>
		</div>
	</header>
...
<!-- Main Title of the Page -->
	<div class="title">
		<span>Prepare for GATE Exams on Compiler Hero</span>
		<div class="shortdesc">
			<p>Learn from Compiler Hero for better higher studies in<br> Indian Institutes of Technologies(IIT)</p>
		</div>
	</div>
...
<!-- Courses Available -->
	...
	<center>
		<div class="ccardbox">
			<div class="dcard">
				<div class="fpart"><img src="../coursesimg/courses/math.jpg"></div>
				<a href="#math"><div class="spart">2 Courses <img src="../coursesimg/icon/dropdown.png"></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src="../coursesimg/courses/digital.jpg"></div>
				<a href="#digital"><div class="spart">5 Courses <img src="../coursesimg/icon/dropdown.png"></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src="../coursesimg/courses/coaa.jpg"></div>
				<a href="#coaa"><div class="spart">3 Courses <img src="../coursesimg/icon/dropdown.png"></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src="../coursesimg/courses/database.jpg"></div>
				<a href="#database"><div class="spart">3 Courses <img src="../coursesimg/icon/dropdown.png"></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src="../coursesimg/courses/data-algo.jpg"></div>
				<a href="computer_courses.html#data"><div class="spart">6 Courses <img src="../coursesimg/icon/dropdown.png"></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src="../coursesimg/courses/compiler.jpg"></div>
				<a href="#compiler"><div class="spart">2 Courses <img src="../coursesimg/icon/dropdown.png"></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src="../coursesimg/courses/os.jpg"></div>
				<a href="#os"><div class="spart">1 Courses <img src="../coursesimg/icon/dropdown.png"></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src="../coursesimg/courses/cn.jpg"></div>
				<a href="#cn"><div class="spart">3 Courses <img src="../coursesimg/icon/dropdown.png"></div></a>
			</div>
		</div>
	</center>
	</div>
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="../coursesimg/courses/math.jpg">
...
<!-- Videos on DIGITAL LOGIC Lectures -->
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="../coursesimg/courses/digital.jpg">
...
<!-- Videos on COMPUTER ORGANIZATION and ARCHITECTURE Lectures -->
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="../coursesimg/courses/coaa.jpg">
...
<!-- Videos on COMPILER Lectures -->
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="../coursesimg/courses/compiler.jpg">
...
<div class="title2" id="os">
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="../coursesimg/courses/os.jpg">
...
<div class="title2" id="database">
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="../coursesimg/courses/database.jpg">
...
<div class="title2" id="cn">
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="../coursesimg/courses/cn.jpg">
...
<footer>
	<div class="footer-container">
		<div class="left-col">
			<img src="../coursesimg/icon/logo - Copy.png" style="width: 200px;">
			<div class="logo"></div>
			...
			<br><p><img src="../coursesimg/icon/location.png"> Anand College of Engineering<br>Jaipur, Rajasthan-303012</p><br>
