...
<head>
	...
	<title>Computer Science Courses on Compiler Hero</title>
	...
	<header>
		<div class="nav" id="nav">
			...
			<ul id="list-switch">
				...
				<li><a href="gate.php"><img src="../coursesimg/courses/paper.png" class="icon">GATE</a></li>
				<li><a href="#"><img src="../coursesimg/courses/computer.png" class="icon">Computer Courses</a></li>
				<li><a href="#data"><img src="../coursesimg/courses/data.png" class="icon">Data Structures</a></li>
				<li><a href="#algo"><img src="../coursesimg/courses/algo.png" class="icon">Algorithm</a></li>
				<li><a href="#projects"><img src="../coursesimg/courses/projects.png" class="icon">Projects</a></li>
			</ul>
			<div class="search" id="search-switch">
				<input type="search" placeholder="Search" class="srch"><button id="srchbtn"><img src="../coursesimg/icon/search.png"></button>
			</div>
		</div>
	</header>
...
<!-- MAIN Heading of Page -->
	<div class="title">
		<span>Computer Science Courses<br>on Compiler Hero</span>
		<div class="shortdesc">
...
<!-- Courses Available -->
	...
	<center>
		<div class="ccardbox">
			<div class="dcard">
				<div class="fpart"><img src="../coursesimg/courses/java-course.jpg"></div>
				<a href="#java"><div class="spart">2 Courses <img src="../coursesimg/icon/dropdown.png"></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src="../coursesimg/courses/python-course.png"></div>
				<a href="#python"><div class="spart">5 Courses <img src="../coursesimg/icon/dropdown.png"></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src="../coursesimg/courses/c-course.jpg"></div>
				<a href="#c++"><div class="spart">3 Courses <img src="../coursesimg/icon/dropdown.png"></div></a>
			</div>
		</div>
		<div class="ccardbox">
			<div class="dcard">
				<div class="fpart"><img src="../coursesimg/courses/web-course.jpg"></div>
				<a href="#html_css"><div class="spart">6 Courses <img src="../coursesimg/icon/dropdown.png"></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src="../coursesimg/courses/data-course.jpg"></div>
				<a href="#data"><div class="spart">2 Courses <img src="../coursesimg/icon/dropdown.png"></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src="../coursesimg/courses/algo-course.jpg"></div>
				<a href="#algo"><div class="spart">1 Courses <img src="../coursesimg/icon/dropdown.png"></div></a>
			</div>
		</div>
	</center>
	</div>
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2">
					<img src="../coursesimg/courses/java-course.jpg">
...
<!-- Videos on C++ Lectures -->
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="../coursesimg/courses/c-course.jpg">
...
<!-- Videos on PYTHON Lectures -->
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="../coursesimg/courses/python-course.png">
...
<!-- Videos on DATA STRUCTURES Lectures -->
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="../coursesimg/courses/data-course.jpg">
...
<!-- Videos on ALGORITHM Lectures -->
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="../coursesimg/courses/algo-course.jpg">
...
<!-- Videos on HTML and CSS Lectures -->
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="../coursesimg/courses/web-course.jpg">
...
<!-- Videos on JAVASCRIPT Lectures -->
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="../coursesimg/courses/javascript-course.jpg">
...
<!-- PROJECTS -->
	...
	<div class="project-panel">
		<div class="project-card">
			<img src="../coursesimg/projects/p1.jpg">
			<div class="info">
		...
		<div class="project-card">
			<img src="../coursesimg/projects/p2.jpg">
			<div class="info">
		...
		<div class="project-card">
			<img src="../coursesimg/projects/p3.jpg">
			<div class="info">
		...
		<div class="project-card">
			<img src="../coursesimg/projects/p4.jpg">
			<div class="info">
		...
		<div class="project-card">
			<img src="../coursesimg/projects/p5.jpg">
			<div class="info">
...
<footer>
	<div class="footer-container">
		<div class="left-col">
			...
			<p><img src="../coursesimg/icon/phone.png"> +91 7878620980<br><img src="../coursesimg/icon/mail.png">&nbsp; learnedonline9419@gmail.com</p>
		</div>
		<div class="right-col">
